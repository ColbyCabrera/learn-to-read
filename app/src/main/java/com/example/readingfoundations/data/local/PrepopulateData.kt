...
object PrepopulateData {
    val readingComprehensionTexts = listOf(
        // Level 1
        ReadingComprehensionText(id = 1, text = "The dog chased the ball.", level = 1),
        // Level 2
        ReadingComprehensionText(id = 2, text = "A girl has a red kite. She flies the kite high.", level = 2),
        // Level 3
        ReadingComprehensionText(id = 3, text = "The sun is bright today. A boy goes to the park to play. He sees a blue bird in a tree. The bird sings a happy song.", level = 3),
        // Level 4
        ReadingComprehensionText(id = 4, text = "The little gray mouse quietly crept across the kitchen floor. He was looking for a tasty crumb of cheese. Suddenly, he heard a loud noise and felt scared. He quickly ran back to his small hole in the wall.", level = 4),
        // Level 5
        ReadingComprehensionText(id = 5, text = "Once, there was a curious cat named Leo. Leo loved to explore the garden behind his house. One sunny afternoon, he saw a bright blue butterfly. He decided to follow it.\n\nThe butterfly fluttered over a tall fence. Leo, determined to keep up, took a big leap and landed softly on the other side. He found himself in a new, exciting place he had never seen before. It was a meadow full of colorful wildflowers.\n\nLeo forgot all about the butterfly and spent the rest of the day happily rolling in the flowers and chasing grasshoppers. He knew he had found his new favorite place to play.", level = 5)
    )
